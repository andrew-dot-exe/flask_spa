...
#TODO: пеерписать под sys.argv для директории, а то мозги делает
PERSONS = 'generator/data/person.json'
ADDRESS = 'generator/data/address.json'
...
class PersonGenerator:
    ...
    def get_passport_number(self):
        ...
        """
        passport = ''.join([str(randint(0, 9)) for i in range(3)]) + ' ' + ''.join([str(randint(0, 9)) for i in range(6)])
        return passport
